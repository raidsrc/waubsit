    ...
    <div className="links-page bg-neutral-500 text-white pb-32">
      ...
      <CenteredFullPageFlexContainer>
        ...
        <div className="mb-10 md:mb-20 ">
          <LinkBlock title="Protein Structure Prediction Evaluator" href="https://github.com/rsrchen/ecs129-project" imgSrc={protStrucPredic}>This program compares the prediction of a protein's 3-D structure (i.e. as made by AlphaFold) to the protein's empirically-determined true structure using the root-mean-square deviation of the two structures' alpha carbon backbones. It also outputs some pretty plots that give you that important information at a glance. This program allows you to evaluate just how accurate a protein structure prediction really is in the matter of a split-second.
          </LinkBlock>

          <LinkBlock title="Tractivity" href="https://tractivity.raidsrc.me" imgSrc={tractivityImg}>A slick, streamlined fitness-tracking web application. Sign in using your Google account, log your past and future physical activity, and generate a bar graph to visualize your progress. It's mad responsive, too. Go view it on your phone. </LinkBlock>

          <LinkBlock title="Shop 'Til You Drop" href="https://shop-til-you-drop.raidsrc.me" imgSrc={shopImg}>A web app I developed in 2021 during the pandemic when I was angrily daydreaming about how much money I'd spent on tuition at UC Davis, only to receive online classes and crippling depression in return. Use this web application to estimate the cost of education at various public universities in California using data drawn from the U.S. Department of Education's College Scorecard API.</LinkBlock>

          <LinkBlock title="Rewrite, Rebuild, Repeat" href="http://uwp101y.raidsrc.me" imgSrc={rewriteImg}>An online collection of essays and blog posts. In this body of work, I investigate the history, geography, and circumstances of two urban redevelopment schemes in the San Francisco Bay Area and examine how money, location, and collective civic action have shaped the outcomes of both projects. There's a chance they'll ask you for a password if you want to gain entry. Email me for that.</LinkBlock>
