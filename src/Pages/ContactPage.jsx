  ...
  return (
    <div className="find-me-page">
      ...
      <CenteredFullPageFlexContainer>
        ...
        <div className="text-left smmd:text-center py-5 px-2 text-base md:text-lg text-white">
        ...
        <div className="grid grid-cols-3 grid-rows-3 md:grid-rows-5">
          <div className="row-start-2 col-start-2 flex justify-center">
            <a target="_blank" rel="noreferrer noopener" href="https://twitter.com/raidsrc" className=" hover:opacity-60 active:opacity-40 flex flex-row flex-wrap puny-ass-screen:flex-nowrap items-center justify-center max-w-min">
        ...
        <div className="grid grid-cols-3 grid-rows-3 md:grid-rows-4">
          <div className="row-start-2 col-start-2 flex justify-center">
            <a href="mailto:rsrchen@ucdavis.edu" className=" hover:opacity-60 active:opacity-40 flex flex-row flex-wrap puny-ass-screen:flex-nowrap items-center justify-center max-w-min">
