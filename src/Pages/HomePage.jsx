    ...
    <div className="homepage">
      <div className="mb-20">
        <div className="w-full py-12 md:py-16 lg:py-0 flex justify-center">
          ...
          <img className="hidden w-screen h-screen lg:block lg:object-cover lg:object-center max-h-h-fhd w-fhd:hidden " src={rayShiprock} />
        </div>
        <HomepageCenteredFullPageFlexContainer>
          <img className="hidden w-fhd:block object-cover object-center w-full my-20 shadow-lg " src={rayShiprock} />
