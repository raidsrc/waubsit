         ...
         <div className="mb-20">
            ...
            <HomepageCenteredFullPageFlexContainer>
               ...
               <p className="homepage-paragraph">
                  Have a look around! I'm sure you'll find something worth your time. You can read a little bit about me in the <span className="inline-red-bg-link"><Link to="/about" onClick={scrollToTop}>About</Link></span> section. Hiring? You can view my résumé in the <span className="inline-red-bg-link"><Link to="/resume" onClick={scrollToTop}>Résumé</Link></span> section. Check out <span className="inline-red-bg-link"><Link to="contact" onClick={scrollToTop}>Find Me</Link></span> if you want to know where you can contact me. I've got links to stuff I've made in <span className="inline-red-bg-link"><Link to="links" onClick={scrollToTop}>More Stuff</Link></span>. And if you want to learn about how I built this site, check out <span className="inline-red-bg-link"><Link to="siteinfo" onClick={scrollToTop}>Site Info</Link></span>.
               </p>
               <p className="homepage-paragraph text-black">
                  Enjoy your stay.
               </p>
