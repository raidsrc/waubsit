      ...
      <div className="mb-20">
        ...
        <HomepageCenteredFullPageFlexContainer>
          ...
          <p className="homepage-paragraph">
            Have a look around! I'm sure you'll find something worth your time. You can read through a short autobiographical exhibit about me on the <span className="inline-red-bg-link"><Link to="/about" onClick={scrollToTop}>About</Link></span> page. You can view my résumé by clicking the <span className="inline-red-bg-link"><Link to="/resume" onClick={scrollToTop}>Résumé</Link></span> link. If you want to know where you can contact me, head over to the <span className="inline-red-bg-link"><Link to="contact" onClick={scrollToTop}>Contact</Link></span> page. You can look at my work on the <span className="inline-red-bg-link"><Link to="links" onClick={scrollToTop}>Stuff I've Made</Link></span> page. And if you want to learn about how I built this site, check out the <span className="inline-red-bg-link"><Link to="siteinfo" onClick={scrollToTop}>Site Info</Link></span> page.
          </p>
          <p className="homepage-paragraph text-black">
            Enjoy your stay.
          </p>
