  ...
  return (
    <div className="site-info-page">
      ...
      <CenteredFullPageFlexContainer>
        ...
        <p className="about-me-paragraph py-3 lg:py-5 text-black">To put this site together, I enlisted the help of <NewTab href="https://vitejs.dev/">vite</NewTab>, <NewTab href="https://reactrouter.com/">react-router-dom</NewTab>, <NewTab href="https://reactcommunity.org/react-transition-group/">react-transition-group</NewTab>, <NewTab href="https://react-spring.io/">react-spring</NewTab>, and <NewTab href="https://tailwindcss.com/">tailwindcss</NewTab>. I'm using <NewTab href="https://firebase.google.com/products/hosting">Firebase Hosting</NewTab> to deliver this site to the world.
        </p>
