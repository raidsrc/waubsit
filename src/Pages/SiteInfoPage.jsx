    ...
    return (
        <div className="site-info-page">
            <CenteredFullPageFlexContainer>
                ...
                <p className="about-me-paragraph text-black py-3 lg:py-5">This site is a <NewTab href="https://reactjs.org/">React</NewTab> app. I got my first taste of React from <span className="italic">ECS 162: Web Programming</span>, a course I took at UC Davis during Spring Quarter 2021. I'm never going back to vanilla JavaScript.</p>
                ...
                <p className="about-me-paragraph text-black py-3 lg:py-5">Building this site took me a couple weeks of on-and-off work. Much of it was spent teaching myself how to use the technologies listed above. I struggled a lot with react-spring in particular, spending hours staring at my laptop screen in the dark cabin of an airplane wondering what was going wrong. Programming is confusing.</p>

                <p className="about-me-paragraph py-3 lg:py-5">If you're reading this right now, I'm still building the site, so I guess the first sentence of the previous paragraph was a lie, since I'm not done yet and I don't know how long it'll take me to finish. Welcome to my in-progress personal website. How the hell did you get here? I haven't told anyone about this site or advertised it anywhere...</p>
