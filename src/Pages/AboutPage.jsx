...
function AboutPage(props) {
  ...
  const aboutSections = [
    ...
    { statement: "I'm a graduate of the University of California, Davis. I majored in biochemistry and molecular biology and minored in computer science. During my time at UC Davis, I engaged in research in molecular genetics and music neuropsychology, performed with the university's jazz ensembles, did a bunch of programming, played a decent amount of late-night Super Smash Bros. Melee, and biked what felt like a million miles. While school was tough sometimes, I'm really grateful for the time I spent in Davis, and I know I'll look back on those years fondly.", image: eggheads, figureNumber: 3, caption: "Egghead - Yin & Yang, outside the music building on the Davis campus." },
    { statement: "I now work at Virovek, the family business. It's a small Hayward-based gene therapy manufacturing company founded and directed by my beloved mother and father. I'm here for a little bit, taking care of IT administration, cybersecurity, and a bit of biotechnological business development. But I'm also intently searching for a new job quick because I kinda want to step out into the unknown, you know? So, if you're in need of a web developer, bioinformaticist, or jazz drummer/pianist (HELL YEAH), hit me up. ", image: virovek, figureNumber: 4, caption: "the front of Virovek's office." },
    ...
    { statement: "In my free time, I enjoy programming, lifting weights, cooking, learning new things, editing videos, and making music. I also really enjoy skiing, snowboarding, and skateboarding, even though I don't typically get to do those things very often.", image: rayPiano2017, figureNumber: 6, caption: "me in 2017, performing \"Showtime - Piano Refrain\" from Homestuck for a few hundred people at a talent show." },
  ]
  return (
