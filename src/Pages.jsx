         ...
         <CenteredFullPageFlexContainer>
            ...
            <div className="grid grid-cols-3 grid-rows-5">
               <div className="row-start-2 col-start-2 flex flex-row items-center justify-center">
                  <a target="_blank" rel="noreferrer noopener" href="https://twitter.com/raidsrc" className=" hover:opacity-60">
               ...
               <div className="row-start-4 col-start-2 flex flex-row items-center justify-center">
                  <a target="_blank" rel="noreferrer noopener" href="https://youtube.com/c/raidsrc" className=" hover:opacity-60">
            ...
            <div className="grid grid-cols-3 grid-rows-6">
               <div className="row-start-2 col-start-2 flex flex-row items-center justify-center">
                  <a href="mailto:rsrchen@ucdavis.edu" className=" hover:opacity-60">
